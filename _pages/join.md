...
![Beaumont Tower at Michigan State University]({{ site.url }}{{ site.baseurl }}/images/tower.png){: style="width: 300px; float: left; border: 10px"}
![Michigan State University campus during autumn]({{ site.url }}{{ site.baseurl }}/images/msufall.png){: style="width: 300px; float: center; border: 10px"}
